...
public class TagFilterActivity extends BaseActivity {
    ...
    private void addFilterFragment() {
        fragment = new TagFilterFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable("FILTER_DATA", mParms);
        bundle.putParcelable("TAG_LOCATION", loaction);

        fragment.setArguments(bundle);
        addFragmentWithBackstack(R.id.home_container, fragment, TagFilterFragment.class.getSimpleName());
    }
