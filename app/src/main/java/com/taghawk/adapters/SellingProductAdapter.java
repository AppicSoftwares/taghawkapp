...
public class SellingProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private ArrayList<ProductDetailsData> mList;
    private View.OnClickListener listener;
    private boolean status;

    public SellingProductAdapter(ArrayList<ProductDetailsData> mList, View.OnClickListener listener, boolean status) {
        this.mList = mList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        if (i == AppConstants.LIST_VIEW_TYPE) {
            ...
            return new SellingProductAdapter.ProductListViewModel(mBinding);
        } else {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof ProductListViewModel) {
            SellingProductAdapter.ProductListViewModel holder = null;
            holder = (SellingProductAdapter.ProductListViewModel) viewHolder;
