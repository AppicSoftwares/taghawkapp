...
public class TabProductsPagerAdapter extends FragmentPagerAdapter {

    public static final Integer[] tabNames = {R.string.tab_selling, R.string.tab_sold, R.string.tab_saved};//Tab title array

    AppCompatActivity mActivity;
    private String sellerId;

    public TabProductsPagerAdapter(FragmentManager manager, AppCompatActivity ac, String sellerId) {
        super(manager);
        mActivity = ac;
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                return tab2;
            case 2:
                SavedProductsFragment tab3;
                tab3 = new SavedProductsFragment();
